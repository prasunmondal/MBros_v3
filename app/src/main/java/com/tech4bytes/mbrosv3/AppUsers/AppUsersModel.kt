...
data class AppUsersModel(val id: String, val timestamp: String, val device_id: String, val PIN: String, var roles: String, var permissions: String) : java.io.Serializable {
